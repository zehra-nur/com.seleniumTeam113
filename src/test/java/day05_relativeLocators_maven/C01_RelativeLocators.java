...
public class C01_RelativeLocators {
    public static void main(String[] args) throws InterruptedException {
        ...
        /*
           Aslinda Berlin elementini id='pid7_thumb' seklinde locate edebiliriz.
           relative locator, locate edilemeyen webelementler icin tasarlanmistir
           biz ornek olmasi için Berlin elementi uzerinde deniyoruz
           (aradigimiz webelementin bir ozelligi) + locate edilebilen bir web elemente gore konumu
         */
        ...
        // test etmek için  berlin1 webelementinin id attribute'nun degerine bakalim - pid_thumb olmali
